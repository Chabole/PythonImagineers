# -*- coding: utf-8 -*-
"""
Created on Mon Aug 23 16:22:39 2021
...
# def model(t, h):
#   dx1dt = x2
#   dx2dt = (omega**2)*Y*np.sin(omega*t) - alpha*x2 - beta*x1
#   return [dx1dt, dx2dt] 
...
def invpend_ode(x, t, Y=1):
     #return x[1], -1 - alpha*x[0] - beta*x[1]
     #return x[1], (omega**2)*Y*np.sin(omega*t) - alpha*x[0] - beta*x[1]
     return x[1], -x[1]*(1 + (Y*x[1])**2)
